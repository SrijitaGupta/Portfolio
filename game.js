...
let about = ["My name is Srijita Gupta","I'm a student of Msc informatics","My skills include HTML,CSS,JAVASCRIPT,JAVA & C++","You can contact me at srijita.gupta@iic.ac.in","Thank You"]
let detail = document.querySelector(".details");
let index = 0;
const intervalId = setInterval(() => {
    if (index < about.length) {
        detail.textContent = `${about[index]}`; 
        index++; 
    } else {
